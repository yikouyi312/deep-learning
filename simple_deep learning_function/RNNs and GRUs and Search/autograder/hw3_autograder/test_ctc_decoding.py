...
class SearchTest(Test):
    ...
    def test_greedy_search(self):
        ...
        expected_results = np.load(
            os.path.join(
                # "autograder", "hw3_autograder", "data", "greedy_search.npy"
                "/Users/boweiouyang/Desktop/intro_to_ml/handout/autograder/hw3_autograder/data/greedy_search.npy"
            ),
            allow_pickle=True,
        )
    ...
    def test_beam_search(self):
        expected_results = np.load(
            os.path.join(
                # "autograder", "hw3_autograder", "data", "beam_search.npy"
                "/Users/boweiouyang/Desktop/intro_to_ml/handout/autograder/hw3_autograder/data/beam_search.npy"
            ),
            allow_pickle=True,
        )
